...
\paragraph{Field: Maximum Outdoor Dry-Bulb Temperature for Compressor Operation}

This numeric field defines the maximum outdoor air dry-bulb temperature where the cooling coil compressor turns off. If this input field is left blank, the default value is 60 °C (140 °F).
...
Coil:Cooling:DX:CurveFit:Performance,
  ...
  125.0,     !- Maximum Outdoor Dry-Bulb Temperature for Compressor Operation {C}
