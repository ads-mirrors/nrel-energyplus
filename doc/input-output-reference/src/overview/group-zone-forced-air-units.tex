...
\paragraph{Field: Heating Fuel Efficiency Schedule Name}\label{field-heating-fuel-efficiency-schedule-name}

This optional input field is the name of a \textbf{Schedule} object. The name must correspond to unique name of a \textit{schedule} object. References heating fuel efficiency value for converting heating ideal air loads into heating fuel energy consumption. The minimum schedule value must be greater than 0.0. The maximum value depends on the technology, and can exceed 1 (e.g. a DX Heating Coil). If blank, heating fuel efficiency value is always 1.0.

\paragraph{Field: Heating Fuel Type}\label{field-heating-fuel-type}

This is an optional input alpha field that determines the heating fuel type used by the ideal loads air system. This field offers thirteen choices: Electricity, NaturalGas, Propane, Diesel, Gasoline, FuelOilNo1, FuelOilNo2, OtherFuel1, OtherFuel2, DistrictCooling, DistrictHeatingWater, or DistrictHeatingSteam. The default key choice is DistrictHeatingWater.

\paragraph{Field: Cooling Fuel Efficiency Schedule Name}\label{field-cooling-fuel-efficiency-schedule-name}

This optional input field is the name of a \textbf{Schedule} object. The name must correspond to unique name of a \textit{schedule} object. References cooling fuel efficiency value for converting cooling ideal air loads into cooling fuel energy consumption. The minimum schedule value must be greater than 0.0. The maximum value depends on the technology, and can exceed 1 (e.g. a DX Cooling Coil). If blank, cooling fuel efficiency value is always 1.0.

\paragraph{Field: Cooling Fuel Type}\label{field-cooling-fuel-type}

This is an optional input alpha field that determines the cooling fuel type used by the ideal loads air system. This field offers thirteen choices: Electricity, NaturalGas, Propane, Diesel, Gasoline, FuelOilNo1, FuelOilNo2, OtherFuel1, OtherFuel2, DistrictCooling, DistrictHeatingWater, or DistrictHeatingSteam. The default key choice is DistrictCooling.
...
\item
  HVAC,Sum,Zone Ideal Loads Supply Air Total Heating Fuel Energy {[}J{]}
\item
  HVAC,Sum,Zone Ideal Loads Supply Air Total Cooling Fuel Energy {[}J{]}
\item
  HVAC,Sum,Zone Ideal Loads Zone Heating Fuel Energy {[}J{]}
\item
  HVAC,Sum,Zone Ideal Loads Zone Cooling Fuel Energy {[}J{]}
\item
...
\item
  HVAC,Sum,Zone Ideal Loads Supply Air Total Heating Fuel Energy Rate {[}W{]}
\item
  HVAC,Sum,Zone Ideal Loads Supply Air Total Cooling Fuel Energy Rate {[}W{]}
\item
  HVAC,Sum,Zone Ideal Loads Zone Heating Fuel Energy Rat {[}W{]}
\item
  HVAC,Sum,Zone Ideal Loads Zone Cooling Fuel Energy Rat {[}W{]}
\item
...
\paragraph{Zone Ideal Loads Supply Air Total Heating Fuel Energy {[}J{]}}\label{zone-ideal-loads-supply-air-total-heating-fuel-energy-j}

\paragraph{Zone Ideal Loads Supply Air Total Heating Fuel Energy Rate {[}W{]}}\label{zone-ideal-loads-supply-air-total-heating-fuel-energy-rate-w}

The total heating fuel energy (or rate) consumed to raise the mixed air stream to the temperature and humidity ratio of the supply air stream, to maintain the desired air conditions in a heated zone. It is calculated by dividing the Zone Ideal Loads Supply Air Total Heating Energy (or Rate) by the heating fuel efficiency.

\paragraph{Zone Ideal Loads Supply Air Total Cooling Fuel Energy {[}J{]}}\label{zone-ideal-loads-supply-air-total-cooling-fuel-energy-j}

\paragraph{Zone Ideal Loads Supply Air Total Cooling Fuel Energy Rate {[}W{]}}\label{zone-ideal-loads-supply-air-total-cooling-fuel-energy-rate-w}

The total cooling fuel energy (or rate) consumed to lower the mixed air stream to the temperature and humidity ratio of the supply air stream, to maintain the desired air conditions in a cooled zone. It is calculated by dividing the Zone Ideal Loads Supply Air Total Cooling Energy (or Rate) by the cooling fuel efficiency.
...
\paragraph{Zone Ideal Loads Zone Heating Fuel Energy {[}J{]}}\label{zone-ideal-loads-zone-heating-fuel-energy-j}

\paragraph{Zone Ideal Loads Zone Heating Fuel Energy Rate {[}W{]}}{zone-ideal-loads-zone-heating-fuel-energy-rate-w}

The total heating fuel energy (or rate) consumed to maintain the desired air conditions in the heated zone is calculated by dividing the Zone Ideal Loads Zone Total Heating Energy (or Rate) by the heating fuel efficiency.

\paragraph{Zone Ideal Loads Zone Cooling Fuel Energy {[}J{]}}\label{zone-ideal-loads-zone-cooling-fuel-energy-j}

\paragraph{Zone Ideal Loads Zone Cooling Fuel Energy Rate {[}W{]}}\label{zone-ideal-loads-zone-cooling-fuel-energy-rate-w}
  
The total cooling fuel energy (or rate) consumed to maintain the desired air conditions in the cooled zone is calculated by dividing the Zone Ideal Loads Zone Total Cooling Energy (or Rate) by the cooling fuel efficiency.
