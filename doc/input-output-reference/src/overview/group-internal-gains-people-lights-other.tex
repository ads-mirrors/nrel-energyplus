...
specified, 60$^\circ$F (or 15.56$^\circ$C) will be used as the default temperature threshold.
...
\toprule
Operative Temperature ($^\circ$C) & Humidity Ratio (kgWater/kgDryAir) \tabularnewline
\midrule
\endfirsthead
