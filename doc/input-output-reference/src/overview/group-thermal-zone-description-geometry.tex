...
Zone,Average,Zone Opaque Surface Inside Faces Conduction [W]
Zone,Average,Zone Opaque Surface Inside Faces Conduction Heat Gain Rate [W]
Zone,Average,Zone Opaque Surface Inside Faces Conduction Heat Loss Rate [W]
Zone,Sum,Zone Opaque Surface Inside Faces Conduction Heat Gain Energy [J]
Zone,Sum,Zone Opaque Surface Inside Faces Conduction Heat Loss Energy [J]
Zone,Average,Zone Opaque Surface Outside Faces Conduction [W]
Zone,Average,Zone Opaque Surface Outside Faces Conduction Gain[W]
Zone,Average,Zone Opaque Surface Outside Faces Conduction Loss[W]
Zone,Sum,Zone Opaque Surface Outside Faces Conduction Heat Gain Energy [J]
Zone,Sum,Zone Opaque Surface Outside Faces Conduction Heat Loss Energy [J]
...
\subsubsection{Zone Opaque Surface Inside Faces Conduction {[}W{]}}\label{zone-opaque-surface-inside-face-conduction-w}

The sum of the Opaque Surface Inside Face Conduction values for all opaque surfaces in a zone for both positive and negative sums. For example, assume a zone has six opaque surfaces with Opaque Surface Inside Face Conduction values of 100, -200, 400, 50, 150 and --300 W. Then Zone Opaque Surface Inside Faces Conduction = 700 - 500 = 200 W. Or if a zone has six opaque surfaces with Opaque Surface Inside Face Conduction values of -100, -200, 400, -50, 150 and --300W. Then Zone Opaque Surface Inside Faces Conduction = 550 -- 650 = -100 W.

\subsubsection{Zone Opaque Surface Inside Faces Conduction Heat Gain Rate {[}W{]}}\label{zone-opaque-surface-inside-faces-conduction-heat-gain-rate-w}

\subsubsection{Zone Opaque Surface Inside Faces Conduction Heat Gain Energy {[}J{]}}\label{zone-opaque-surface-inside-faces-conduction-heat-gain-energy-j}
...
\subsubsection{Zone Opaque Surface Inside Faces Conduction Heat Loss Rate {[}W{]}}\label{zone-opaque-surface-inside-faces-conduction-heat-loss-rate-w}

\subsubsection{Zone Opaque Surface Inside Faces Conduction Heat Loss Energy {[}J{]}}\label{zone-opaque-surface-inside-faces-conduction-heat-loss-energy-j}
...
\subsubsection{Zone Opaque Surface Outside Faces Conduction {[}W{]}}\label{zone-opaque-surface-outside-face-conduction-w}

The sum of the Opaque Surface Outside Face Conduction values for all opaque surfaces in a zone for both positive and negative sums. For example, assume a zone has six opaque surfaces with Opaque Surface Outside Face Conduction values of 100, -200, 400, 50, 150 and --300 W. Then Zone Opaque Surface Outside Faces Conduction = 700 - 500 = 200 W. Or if a zone has six opaque surfaces with Opaque Surface Outside Face Conduction values of -100, -200, 400, -50, 150 and --300W. Then Zone Opaque Surface Outside Faces Conduction = 550 -- 650 = -100 W.

\subsubsection{Zone Opaque Surface Outside Faces Conduction Gain {[}W{]}}\label{zone-opaque-surface-outside-face-conduction-gain-w}

\subsubsection{Zone Opaque Surface Outside Faces Conduction Gain Energy {[}J{]}}\label{zone-opaque-surface-outside-face-conduction-gain-energy-j}

These are the power and energy sums for the Opaque Surface Outside Face Conduction values for all opaque surfaces in a zone when that sum is positive. For example, assume a zone has six opaque surfaces with Opaque Surface Outside Face Conduction values of 100, -200, 400, 50, 150 and --300 W. Then Zone Opaque Surface Outside Faces Conduction Gain = 700 - 500 = 200 W.

\subsubsection{Zone Opaque Surface Outside Faces Conduction Loss {[}W{]}}\label{zone-opaque-surface-outside-face-conduction-loss-w}

\subsubsection{Zone Opaque Surface Outside Faces Conduction Loss Energy {[}J{]}}\label{zone-opaque-surface-outside-face-conduction-loss-energy-j}

These are the power and energy absolute value for the sums of the Opaque Surface Outside Face Conduction values for all opaque surfaces in a zone when that sum is negative. For example, assume a zone has six opaque surfaces with Opaque Surface Outside Face Conduction values of -100, -200, 400, -50, 150 and -300W. Then Zone Opaque Surface Outside Faces Conduction Loss = \textbar{}550 -- 650\textbar{} = \textbar{}-100\textbar{} = 100 W.
