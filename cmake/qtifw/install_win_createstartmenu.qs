 ...
 */
      ...
      component.addOperation("CreateShortcut", "@TargetDir@/windows_gui_launcher.exe eplaunch", target_dir + "/EP-Launch.lnk");
      ...
      component.addOperation("CreateShortcut", "@TargetDir@/windows_gui_launcher.exe updater", target_dir + "/IDFVersionUpdater.lnk");
