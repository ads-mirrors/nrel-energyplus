...
This is an optional input alpha field that determines the heating fuel type used by the ideal load air system. This field offers thirteen choices: Electricity, NaturalGas, Propane, Diesel, Gasoline, FuelOilNo1, FuelOilNo2, OtherFuel1, OtherFuel2, DistrictCooling, DistrictHeatingWater, or DistrictHeatingSteam. The default key choice is DistrictHeatingWater.
...
This is an optional input alpha field that determines the cooling fuel type used by the ideal load air system. This field offers thirteen choices: Electricity, NaturalGas, Propane, Diesel, Gasoline, FuelOilNo1, FuelOilNo2, OtherFuel1, OtherFuel2, DistrictCooling, DistrictHeatingWater, or DistrictHeatingSteam. The default key choice is DistrictCooling.
