...
\item
  HVAC,Average,Infiltration Outdoor Density Volume Flow Rate {[}m3/s{]}
\item
...
\item
  HVAC,Average,Infiltration Standard Density Air Change Rate {[}ACH{]}
\item
  HVAC,Average,Infiltration Outdoor Density Air Change Rate {[}ACH{]}
\end{itemize}
...
\item
  HVAC,Average,Zone Infiltration Outdoor Density Volume Flow Rate {[}m3/s{]}
\item
...
\item
  HVAC,Average,Zone Infiltration Standard Density Air Change Rate {[}ACH{]}
\item
  HVAC,Average,Zone Infiltration Outdoor Density Air Change Rate {[}ACH{]}
\end{itemize}
...
\paragraph{Zone Infiltration Outdoor Density Volume Flow Rate {[}m3/s{]}}\label{zone-infiltration-outdoor-density-volume-flow-rate-m3s}

This output is the volume flow rate of infiltration air based on the current density of outdoor air.
...
\paragraph{Zone Infiltration Standard Density Air Change Rate {[}ach{]}}\label{zone-infiltration-standard-air-change-rate-ach}
\paragraph{Zone Infiltration Outdoor Density Air Change Rate {[}ach{]}}\label{zone-infiltration-outdoor-air-change-rate-ach}

These outputs are the rate of infiltration in air changes per hour, converted from mass flow rate to volume flow rate using the current zone air density, standard density, or the current outdoor density, respectively. Standard density in EnergyPlus corresponds to 20$^\circ$C drybulb, dry air, and nominally adjusted for elevation.
...
\item
  HVAC,Average,Zone Ventilation Outdoor Density Volume Flow Rate {[}m3/s{]}
\item
...
\item
  HVAC,Average,Zone Ventilation Standard Density Air Change Rate {[}ACH{]}
\item
  HVAC,Average,Zone Ventilation Outdoor Density Air Change Rate {[}ACH{]}
\item
...
\paragraph{Zone Ventilation Outdoor Density Volume Flow Rate {[}m3/s{]}}\label{zone-ventilation-outdoor-density-volume-flow-rate-m3s}

This output is the volume flow rate of ventilation air based on the current density of outdoor air.
...
\paragraph{Zone Ventilation Standard Density Air Change Rate {[}ach{]}}\label{zone-ventilation-standard-air-change-rate-ach}
\paragraph{Zone Ventilation Outdoor Density Air Change Rate {[}ach{]}}\label{zone-ventilation-outdoor-air-change-rate-ach}

These outputs are the rate of ventilation in air changes per hour, converted from mass flow rate to volume flow rate using the current zone air density, standard density, or the current outdoor density, respectively. Standard density in EnergyPlus corresponds to 20$^\circ$C drybulb, dry air, and nominally adjusted for elevation.
