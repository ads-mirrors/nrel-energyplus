...
To understand how when data elements can be populated by either EnergyPlus as the source of the RPD data elements, a
specially tagged version of the schema file was created here:
