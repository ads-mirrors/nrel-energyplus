...
SUBROUTINE SetThisVersionVariables()
      ...
      VerString='Conversion 24.2 => 25.1'
      VersionNum=25.1
      ...
      sVersionNum = '***'
      sVersionNumFourChars='25.1'
      IDDFileNameWithPath=TRIM(ProgramPath)//'V24-2-0-Energy+.idd'
      NewIDDFileNameWithPath=TRIM(ProgramPath)//'V25-1-0-Energy+.idd'
      RepVarFileNameWithPath=TRIM(ProgramPath)//'Report Variables 24-2-0 to 25-1-0.csv'
END SUBROUTINE
