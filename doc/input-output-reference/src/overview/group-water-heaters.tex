...
This required numeric field contains the nominal capacity of the ice storage in GJ (Giga is 10\(^{9}\)). This field is autosizable when Coil:Cooling:Water or Coil:Cooling:Water:DetailedGeometry objects are used within the plant. Other plant equipment have not yet been added to the autosizing capability (e.g., zone or air loop water source heat pumps).
